...
class CustomPageSelectorForTariff extends StatelessWidget {
  /// Creates a compact widget that indicates which tab has been selected.
  const CustomPageSelectorForTariff({
    Key? key,
    this.controller,
  ...
  /// This widget's selection and animations state.
  ///
  ...
  ///
  /// If this parameter is null, then the indicator is filled with [Colors.red].
  final Color? color;
  ...
  Widget _buildTabIndicator(
    ...
    if (tabController.indexIsChanging) {
      // The selection's animations is animating from previousValue to value.
